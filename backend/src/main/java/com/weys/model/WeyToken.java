...
@MongoEntity(collection = "weyTokens")
public class WeyToken extends PanacheMongoEntity {
    ...
    public static class HolderInfo {
        ...
        private boolean isWey;

        public HolderInfo() {
        }

        public HolderInfo(String publicKey, String pfp, String domain, boolean isWey) {
