...
import com.weys.service.TrenchService;
...
public class TrenchResource {
     ...
     * This endpoint is publicly accessible and fetches all tokens held by Wey
     * community members
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Map<String, Object> discoverWeyTokens() {
        Map<String, Object> response = new HashMap<>();

        try {
            String result = weyTokensService.discoverAndAddWeyTokens();
            response.put("success", true);
