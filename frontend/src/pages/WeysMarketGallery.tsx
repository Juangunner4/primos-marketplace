...
const WeysMarketGallery: React.FC = () => {
      ...
      const pageNFTs: MarketNFT[] = await Promise.all(
        listings.map(async (listing: any) => {
          ...
          try {
            ...
            listingsWithoutMetadata++;
            missingData.noMetadata.push(listing.tokenMint);
            console.warn(`[WeysMarketGallery Debug] Failed to get metadata for ${listing.tokenMint}:`, e);
          }
  ...
  return (
    ...
    <AdminDeveloperConsole 
      debugInfo={debugInfo}
      componentName="WeysMarketGallery (Market)"
      additionalData={{
        loading,
...
export default WeysMarketGallery;
